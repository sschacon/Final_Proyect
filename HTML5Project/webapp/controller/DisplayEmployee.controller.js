sap.ui.define([
    ...
    function onRiseEmployee(oEvent) {
        if (!this.riseDialog) {
            ...
            this.riseDialog = sap.ui.xmlfragment("logaligroup/HTML5Project/fragment/RiseEmployee", this);
    ...
    return Controller.extend("logaligroup.HTML5Project.controller.DisplayEmployee", {
        onInit: onInit,
